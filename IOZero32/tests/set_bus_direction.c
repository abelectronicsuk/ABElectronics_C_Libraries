...
Version 1.0 Created 01/04/2022
      ...
      compile with "gcc set_bus_direction.c ../ABE_IOZero32.c -Wall -Wextra -Wpedantic -Woverflow -o set_bus_direction"
      run with "./set_bus_direction"
 
This test validates the set_bus_direction method in the ABE_IOZero32 library.
