...
Version 1.0 Created 04/03/2020
      ...
      compile with "gcc invert_bus.c ../ABE_IoPi.c -Wall -Wextra -Wpedantic -Woverflow -o invert_bus"
      run with "./invert_bus"
 
This test validates the invert_bus method in the ABE_IoPi library.
