...
Version 1.0 Created 04/03/2020
      ...
      compile with "gcc get_pin_direction.c ../ABE_IoPi.c -Wall -Wextra -Wpedantic -Woverflow -o get_pin_direction"
      run with "./get_pin_direction"
 
This test validates the get_pin_direction method in the ABE_IoPi library.
