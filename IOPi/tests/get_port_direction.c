...
Version 1.0 Created 04/03/2020
      ...
      compile with "gcc get_port_direction.c ../ABE_IoPi.c -Wall -Wextra -Wpedantic -Woverflow -o get_port_direction"
      run with "./get_port_direction"
 
This test validates the get_port_direction method in the ABE_IoPi library.
