/*
set_interrupt_polarity.c

Version 1.0 Created 04/03/2020

      compile with "gcc set_interrupt_polarity.c ../ABE_IoPi.c -Wall -Wextra -Wpedantic -Woverflow -o set_interrupt_polarity"
      run with "./set_interrupt_polarity"
 
This test validates the set_interrupt_polarity method in the ABE_IoPi library.
