...
Version 1.0 Created 04/03/2020
      ...
      compile with "gcc set_bus_pullups.c ../ABE_IoPi.c -Wall -Wextra -Wpedantic -Woverflow -o set_bus_pullups"
      run with "./set_bus_pullups"
 
This test validates the set_bus_pullups method in the ABE_IoPi library.
