...
Version 1.0 Created 04/03/2020
      ...
      compile with "gcc set_bus_direction.c ../ABE_IoPi.c -Wall -Wextra -Wpedantic -Woverflow -o set_bus_direction"
      run with "./set_bus_direction"
 
This test validates the set_bus_direction method in the ABE_IoPi library.
